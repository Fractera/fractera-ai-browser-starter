...
const EN: ApiDocWords = {
  ...
  limits: {
    items: [
      ...
      "Up to 10 addresses per call and 3 open at once; each address has 90 s. HTML over 5,000,000 characters and text over 1,000,000 are cut and marked, lists keep 300 items with their total.",
...
const RU: ApiDocWords = {
  ...
  limits: {
    items: [
      ...
      "До 10 адресов за вызов, одновременно 3; на каждый адрес 90 с. HTML длиннее 5 000 000 знаков и текст длиннее 1 000 000 обрезаются с пометкой, списки хранят 300 записей и total.",
